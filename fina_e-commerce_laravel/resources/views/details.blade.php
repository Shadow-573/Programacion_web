                            ...
                            <div class="product-box">
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="main-price">
                                        <a href="{{ asset('assets/images/fashion/product/front')}}/{{$rproduct->image}}" class="font-default" style="background-size: cover; background-position: center center; background-repeat: no-repeat; display: block;">
                                            <h5>{{ $rproduct->name }}</h5>
                                        </a>
