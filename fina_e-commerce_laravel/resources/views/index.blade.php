...
<section class="pt-0 poster-section">
        <div class="poster-image slider-for custome-arrow classic-arrow">
            <div>
                <img src="{{ asset('assets/images/peluches/cane_peluche.png')}}" class="img-fluid blur-up lazyload" alt="">
            </div>
            <div>
                <img src="{{ asset('assets/images/peluches/ponmi_peluche.png')}}" class="img-fluid blur-up lazyload" alt="">
            </div>
            <div>
                <img src="{{ asset('assets/images/peluches/ojolera_2.png')}}" class="img-fluid blur-up lazyload" alt="">
            </div>
        </div>
        <div class="slider-nav image-show">
            <div>
                <div class="poster-img">
                    <img src="{{ asset('assets/images/peluches/cane_peluche.png')}}" class="img-fluid blur-up lazyload" alt="" width="120">
            ...
            <div>
                <div class="poster-img">
                    <img src="{{ asset('assets/images/peluches/ponmi_peluche.png')}}" class="img-fluid blur-up lazyload" alt="" width="120">
                    <div class="overlay-color">
                        <i class="fas fa-plus theme-color"></i>
                    </div>
                </div>
            ...
            <div>
                <div class="poster-img">
                    <img src="{{ asset('assets/images/peluches/ojolera_2.png')}}" class="img-fluid blur-up lazyload" alt="" width="120">
                    <div class="overlay-color">
                        <i class="fas fa-plus theme-color"></i>
                    </div>
                </div>
        ...
        <div class="left-side-contain">
            <div class="banner-left">
                <h4>Sale <span class="theme-color">25% Off</span></h4>
                <h1>New Latest <span>Plushes</span></h1>
