                                ...
                                <div class="brand-logo">
                                    <a href="{{route('app.index')}}">
                                        <table>
                                            <tr>
                                                <td>
                                                <img src="{{ asset('assets/images/logo.gif')}}" class="h-logo img-fluid blur-up lazyload"
                                            alt="logo" width="100">
                                                </td>
                                                <td>
                                                <h2> Neco</h2>
                                ...
                                <div class="main-navbar">
                                    <div id="mainnav">
                                        ...
                                        <ul class="nav-menu">
                                            ...
                                            <li><a href="index.htm" class="nav-link menu-title">Inicio</a></li>
                                            <li><a href="shop.html" class="nav-link menu-title">Tienda</a></li>
                ...
                <div class="row gy-4">
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            ...
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>Telefono:</b> <span class="font-light"> +57 3152162222</span></span>
                                </li>
                                <li>
                                    <span><b>Direccion:</b><span class="font-light"> COLOMBIA, Santander, Bucaramanga.</span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"> GabrielGameplays@outlook.es</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                        <div class="footer-links">
                            ...
                            <img src="{{asset('assets/images/iconos/visa_logo.png')}}" alt="Visa">
            <img src="{{asset('assets/images/iconos/Mastercard_logo.png')}}" alt="MasterCard">
            <img src="{{asset('assets/images/iconos/American_Express_logo.svg')}}" alt="American Express">
            <img src="{{asset('assets/images/iconos/paypal_logo.png')}}" alt="Paypal">
            <img src="{{asset('assets/images/iconos/efecty_logo.webp')}}" alt="Efecty">
            <img src="{{asset('assets/images/iconos/nequi_logo.png')}}" alt="Nequi">
            <img src="{{asset('assets/images/iconos/pse_logo.png')}}" alt="PSE">
